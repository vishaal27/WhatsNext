...
//        }
//
//        cursor=(new CreateEventDbHelper(getApplicationContext()).getReadableDatabase().rawQuery("select * from "+ CreateEventContract.CreateEventEntry.TABLE_NAME, null));
//
//
//
//        if (cursor.moveToFirst()) {
//            while (!cursor.isAfterLast()) {
//                String eventName = cursor.getString(cursor.getColumnIndex(CreateEventContract.CreateEventEntry.COLUMN_EVENT_NAME));
//                String day1 = cursor.getString(cursor.getColumnIndex(CreateEventContract.CreateEventEntry.COLUMN_DATE));
//                String timeFrom=cursor.getString(cursor.getColumnIndex(CreateEventContract.CreateEventEntry.COLUMN_TIME_FROM));
//                String timeTo=cursor.getString(cursor.getColumnIndex(CreateEventContract.CreateEventEntry.COLUMN_TIME_TO));
//
//
//
//                createItemList.add(new CreateItem(timeFrom, timeTo, eventName, day1));
//
//                Log.d("TAG", day1+" ,"+eventName+" ,"+timeFrom+" ,"+timeTo);
//                cursor.moveToNext();
//            }
...
//        };
    ...
    protected void onResume() {
        ...
        mAdapter1 = new CreatedEventsCustomAdapter(createItemList.size(), this);
